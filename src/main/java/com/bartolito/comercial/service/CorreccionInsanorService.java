...
import com.bartolito.comercial.repository.CorreccionInsanorRepository;
...
@Service
public class CorreccionInsanorService {

    @Autowired
    private CorreccionInsanorRepository repository;
